...
clone this repo. Finally, download and extract the [atlases folder](https://drive.google.com/file/d/1cY77rU5f-xnoVCkOj0dRJIFgtk94HBsF/view?usp=sharing) and move the result into the repo. The `atlases` folder should have 5 subfolders, and each of those should have 3 subfiles titled `label.nrrd`, `reference.nrrd`, and `names_dict.csv`.
